...
public abstract class j extends c implements b {
    ...
    public final void H(Activity activity) {
        ...
        f1.n(viewComponentManager$FragmentContextWrapper == null || f.b(viewComponentManager$FragmentContextWrapper) == activity, "onAttach called multiple times with different Context! Hilt Fragments should not be retained.", new Object[0]);
        t0();
        if (!this.P0) {
            this.P0 = true;
            ChoosePasswordBottomSheet choosePasswordBottomSheet = (ChoosePasswordBottomSheet) this;
            ((g) g()).l();
        }
    }

...
public final class h0 extends g0 implements a.C0247a {
    ...
    static {
        ...
        Z = sparseIntArray;
        sparseIntArray.put(R.id.btn_close_info, 2);
    ...
    public h0(androidx.databinding.d r9, android.view.View r10) {
        /*
            r8 = this;
        ...
        L_0x0052:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: nc.h0.<init>(androidx.databinding.d, android.view.View):void");
    }

    public final void b(int i8) {
        b bVar = this.V;
        if (bVar != null) {
            y0 y0Var = bVar.f16705g;

...
public final class e {
    ...
    public final void a() {
        /*
            r2 = this;
            monitor-enter(r2)
            boolean r0 = r2.f17115a     // Catch:{ all -> 0x002d }
            if (r0 == 0) goto L_0x0007
            monitor-exit(r2)     // Catch:{ all -> 0x002d }
            return
        L_0x0007:
            r0 = 1
            r2.f17115a = r0     // Catch:{ all -> 0x002d }
            r2.f17117c = r0     // Catch:{ all -> 0x002d }
            y1.e$a r0 = r2.f17116b     // Catch:{ all -> 0x002d }
            monitor-exit(r2)     // Catch:{ all -> 0x002d }
            r1 = 0
        ...
        L_0x0016:
            r0 = move-exception
            monitor-enter(r2)
            r2.f17117c = r1     // Catch:{ all -> 0x001f }
        ...
        L_0x0022:
            monitor-enter(r2)
            r2.f17117c = r1     // Catch:{ all -> 0x002a }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void b(y1.e.a r2) {
        /*
            r1 = this;
            monitor-enter(r1)
        L_0x0001:
            boolean r0 = r1.f17117c     // Catch:{ all -> 0x001c }
            if (r0 == 0) goto L_0x0009
            r1.wait()     // Catch:{ InterruptedException -> 0x0001 }
            goto L_0x0001
        L_0x0009:
            y1.e$a r0 = r1.f17116b     // Catch:{ all -> 0x001c }
            if (r0 != r2) goto L_0x000f
            monitor-exit(r1)     // Catch:{ all -> 0x001c }
            return
        L_0x000f:
            r1.f17116b = r2     // Catch:{ all -> 0x001c }
            boolean r0 = r1.f17115a     // Catch:{ all -> 0x001c }
        ...
        L_0x001c:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: y1.e.b(y1.e$a):void");
    }
}

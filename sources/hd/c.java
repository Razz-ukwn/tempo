...
public final class c implements f {
    ...
    public final ClaimCoinRequestModel f9303a;

    public c(ClaimCoinRequestModel claimCoinRequestModel) {
        this.f9303a = claimCoinRequestModel;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof c) && j.a(this.f9303a, ((c) obj).f9303a);
    }
    ...
    public final String toString() {
        return "ClaimCoinPlaceIndoorBottomSheetArgs(claimCoin=" + this.f9303a + ')';
    }
}

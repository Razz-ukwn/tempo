...
public final class f implements b3.f {
    ...
    public final RegisterUserRequestModel f3634a;

    public f(RegisterUserRequestModel registerUserRequestModel) {
        this.f3634a = registerUserRequestModel;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof f) && j.a(this.f3634a, ((f) obj).f3634a);
    }
    ...
    public final String toString() {
        return "PhoneNumberBottomSheetArgs(registerUser=" + this.f3634a + ')';
    }
}

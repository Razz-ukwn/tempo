        ...
        if (!z13 || !(obj2 instanceof Long)) {
            ...
            if (obj instanceof String) {
                if (obj2 instanceof Byte) {
                    ...
                    while (i8 < length) {
                        arrayList.add(Byte.valueOf((byte) (bytes[i8] ^ ((Number) obj2).byteValue())));
                        i8++;
                    }
                    ...
                    if (!z15 || !(obj2 instanceof Short)) {
                        ...
                        if (!z16 || !(obj2 instanceof Integer)) {
                            ...
                            if (z17 && (obj2 instanceof Long)) {
                                ...
                                f P = f1.P(0, length3);
                                ArrayList arrayList7 = new ArrayList(m.n0(P));
                                e d10 = P.iterator();
                                while (d10.f16719c) {
                                ...
                                f P2 = f1.P(0, length4);
                                ArrayList arrayList8 = new ArrayList(m.n0(P2));
                                e d11 = P2.iterator();
                                while (d11.f16719c) {
                                ...
                                f P3 = f1.P(0, length5);
                                ArrayList arrayList9 = new ArrayList(m.n0(P3));
                                e d12 = P3.iterator();
                                while (d12.f16719c) {
                                ...
                                f P4 = f1.P(0, length6);
                                ArrayList arrayList10 = new ArrayList(m.n0(P4));
                                e d13 = P4.iterator();
                                while (d13.f16719c) {

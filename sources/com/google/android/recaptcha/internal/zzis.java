...
final class zzis<T> implements zzjc<T> {
    ...
    private zzis(int[] iArr, Object[] objArr, int i8, int i10, zzip zzip, int i11, boolean z10, int[] iArr2, int i12, int i13, zziv zziv, zzid zzid, zzjw zzjw, zzgr zzgr, zzik zzik) {
        this.zzc = iArr;
        this.zzd = objArr;
        this.zze = i8;
        this.zzf = i10;
    ...
    private static long zzA(Object obj, long j10) {
        return ((Long) zzkg.zzf(obj, j10)).longValue();
    }

    private final zzhj zzB(int i8) {
        int i10 = i8 / 3;
        return (zzhj) this.zzd[i10 + i10 + 1];
    }

    private final zzjc zzC(int i8) {
        int i10 = i8 / 3;
        int i11 = i10 + i10;
        zzjc zzjc = (zzjc) this.zzd[i11];
        if (zzjc != null) {
            return zzjc;
        }
        zzjc zzb2 = zziy.zza().zzb((Class) this.zzd[i11 + 1]);
        this.zzd[i11] = zzb2;
        return zzb2;
    }

    private final Object zzD(Object obj, int i8, Object obj2, zzjw zzjw, Object obj3) {
        int i10 = this.zzc[i8];
        Object zzf2 = zzkg.zzf(obj, (long) (zzz(i8) & 1048575));
        if (zzf2 == null || zzB(i8) == null) {
            return obj2;
        }
        zzij zzij = (zzij) zzf2;
        zzii zzii = (zzii) zzE(i8);
        throw null;
    }

    private final Object zzE(int i8) {
        int i10 = i8 / 3;
        return this.zzd[i10 + i10];
    }

    private final Object zzF(Object obj, int i8) {
        zzjc zzC = zzC(i8);
        int zzz = zzz(i8) & 1048575;
        if (!zzT(obj, i8)) {
            return zzC.zze();
        }
    ...
    private final Object zzG(Object obj, int i8, int i10) {
        zzjc zzC = zzC(i10);
        if (!zzX(obj, i8, i10)) {
            return zzC.zze();
        }
        Object object = zzb.getObject(obj, (long) (zzz(i10) & 1048575));
        if (zzW(object)) {
            return object;
        }
        Object zze2 = zzC.zze();
    ...
    private final void zzJ(Object obj, Object obj2, int i8) {
        if (zzT(obj2, i8)) {
            Unsafe unsafe = zzb;
            long zzz = (long) (zzz(i8) & 1048575);
    ...
    private final void zzK(Object obj, Object obj2, int i8) {
        int i10 = this.zzc[i8];
        if (zzX(obj2, i10, i8)) {
            Unsafe unsafe = zzb;
            long zzz = (long) (zzz(i8) & 1048575);
    ...
    private final void zzL(Object obj, int i8, zzjb zzjb) {
        if (zzS(i8)) {
            zzkg.zzs(obj, (long) (i8 & 1048575), zzjb.zzs());
        } else if (this.zzi) {
            zzkg.zzs(obj, (long) (i8 & 1048575), zzjb.zzr());
        } else {
            zzkg.zzs(obj, (long) (i8 & 1048575), zzjb.zzp());
        }
    }

    private final void zzM(Object obj, int i8) {
        int zzw = zzw(i8);
        long j10 = (long) (1048575 & zzw);
        if (j10 != 1048575) {
            zzkg.zzq(obj, j10, (1 << (zzw >>> 20)) | zzkg.zzc(obj, j10));
        }
    }

    private final void zzN(Object obj, int i8, int i10) {
        zzkg.zzq(obj, (long) (zzw(i10) & 1048575), i8);
    }

    private final void zzO(Object obj, int i8, Object obj2) {
        zzb.putObject(obj, (long) (zzz(i8) & 1048575), obj2);
        zzM(obj, i8);
    }

    private final void zzP(Object obj, int i8, int i10, Object obj2) {
        zzb.putObject(obj, (long) (zzz(i10) & 1048575), obj2);
        zzN(obj, i8, i10);
    }

    private final void zzQ(zzko zzko, int i8, Object obj, int i10) {
        if (obj != null) {
            zzii zzii = (zzii) zzE(i10);
            throw null;
        }
    }

    private final boolean zzR(Object obj, Object obj2, int i8) {
        return zzT(obj, i8) == zzT(obj2, i8);
    }

    private static boolean zzS(int i8) {
        return (i8 & 536870912) != 0;
    }

    private final boolean zzT(Object obj, int i8) {
        int zzw = zzw(i8);
        ...
        if (j10 == 1048575) {
            ...
            switch (zzy(zzz)) {
                case 0:
                    return Double.doubleToRawLongBits(zzkg.zza(obj, j11)) != 0;
                case 1:
                    return Float.floatToRawIntBits(zzkg.zzb(obj, j11)) != 0;
                case 2:
                    return zzkg.zzd(obj, j11) != 0;
                case 3:
                    return zzkg.zzd(obj, j11) != 0;
                case 4:
                    return zzkg.zzc(obj, j11) != 0;
                case 5:
                    return zzkg.zzd(obj, j11) != 0;
                case 6:
                    return zzkg.zzc(obj, j11) != 0;
                case 7:
                    return zzkg.zzw(obj, j11);
                case 8:
                    Object zzf2 = zzkg.zzf(obj, j11);
                    if (zzf2 instanceof String) {
                        return !((String) zzf2).isEmpty();
                    }
                    if (zzf2 instanceof zzfi) {
                        return !zzfi.zzb.equals(zzf2);
                    }
                    throw new IllegalArgumentException();
                case 9:
                    return zzkg.zzf(obj, j11) != null;
                case 10:
                    return !zzfi.zzb.equals(zzkg.zzf(obj, j11));
            ...
            return (zzkg.zzc(obj, j10) & (1 << (zzw >>> 20))) != 0;
        }
    }

    private final boolean zzU(Object obj, int i8, int i10, int i11, int i12) {
        return i10 == 1048575 ? zzT(obj, i8) : (i11 & i12) != 0;
    }

    private static boolean zzV(Object obj, int i8, zzjc zzjc) {
        return zzjc.zzl(zzkg.zzf(obj, (long) (i8 & 1048575)));
    }
    ...
    private final boolean zzX(Object obj, int i8, int i10) {
        return zzkg.zzc(obj, (long) (zzw(i10) & 1048575)) == i8;
    }

    private static boolean zzY(Object obj, long j10) {
        return ((Boolean) zzkg.zzf(obj, j10)).booleanValue();
    }

    private static final void zzZ(int i8, Object obj, zzko zzko) {
        if (obj instanceof String) {
            zzko.zzG(i8, (String) obj);
        } else {
            zzko.zzd(i8, (zzfi) obj);
        }
    }
    ...
    public static com.google.android.recaptcha.internal.zzis zzm(java.lang.Class r30, com.google.android.recaptcha.internal.zzim r31, com.google.android.recaptcha.internal.zziv r32, com.google.android.recaptcha.internal.zzid r33, com.google.android.recaptcha.internal.zzjw r34, com.google.android.recaptcha.internal.zzgr r35, com.google.android.recaptcha.internal.zzik r36) {
        ...
        L_0x0359:
            ...
            java.lang.reflect.Field r14 = zzH(r15, r14)
            r10[r24] = r14
        L_0x0361:
            r5 = r1
            r28 = r2
    ...
    private static double zzn(Object obj, long j10) {
        return ((Double) zzkg.zzf(obj, j10)).doubleValue();
    }

    private static float zzo(Object obj, long j10) {
        return ((Float) zzkg.zzf(obj, j10)).floatValue();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:119:0x0333, code lost:
        r8 = r8 + r9;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:190:0x0555, code lost:
        r16 = r8;
        r8 = r3;
        r3 = r16;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:198:0x0576, code lost:
        r5 = r5 + 3;
        r3 = 1048575;
     */
    ...
    private final int zzp(java.lang.Object r18) {
        ...
        L_0x0043:
            ...
            com.google.android.recaptcha.internal.zzjc r8 = r0.zzC(r5)
            int r3 = com.google.android.recaptcha.internal.zzft.zzt(r10, r3, r8)
            goto L_0x04c8
        L_0x0059:
            boolean r8 = r0.zzX(r1, r10, r5)
            if (r8 == 0) goto L_0x0576
            long r8 = zzA(r1, r14)
            int r10 = r10 << 3
            long r11 = r8 + r8
            long r8 = r8 >> r3
            int r3 = com.google.android.recaptcha.internal.zzft.zzy(r10)
            long r8 = r8 ^ r11
            int r8 = com.google.android.recaptcha.internal.zzft.zzz(r8)
            goto L_0x012a
        L_0x0073:
            boolean r3 = r0.zzX(r1, r10, r5)
            if (r3 == 0) goto L_0x0576
            ...
            int r9 = r3 + r3
            int r3 = r3 >> 31
            int r8 = com.google.android.recaptcha.internal.zzft.zzy(r8)
            r3 = r3 ^ r9
        ...
        L_0x00f5:
            ...
            java.lang.Object r3 = r2.getObject(r1, r14)
            com.google.android.recaptcha.internal.zzjc r8 = r0.zzC(r5)
            int r3 = com.google.android.recaptcha.internal.zzje.zzn(r10, r3, r8)
            goto L_0x04c8
        L_0x0109:
            boolean r3 = r0.zzX(r1, r10, r5)
            if (r3 == 0) goto L_0x0576
            java.lang.Object r3 = r2.getObject(r1, r14)
            boolean r8 = r3 instanceof com.google.android.recaptcha.internal.zzfi
        ...
        L_0x01ca:
            java.lang.Object r3 = r2.getObject(r1, r14)
            java.lang.Object r8 = r0.zzE(r5)
            com.google.android.recaptcha.internal.zzik.zza(r10, r3, r8)
            goto L_0x0576
        L_0x01d7:
            java.lang.Object r3 = r2.getObject(r1, r14)
            java.util.List r3 = (java.util.List) r3
            com.google.android.recaptcha.internal.zzjc r8 = r0.zzC(r5)
            int r3 = com.google.android.recaptcha.internal.zzje.zzi(r10, r3, r8)
            goto L_0x04c8
        L_0x01e7:
            java.lang.Object r3 = r2.getObject(r1, r14)
            java.util.List r3 = (java.util.List) r3
        ...
        L_0x0277:
            java.lang.Object r3 = r2.getObject(r1, r14)
            java.util.List r3 = (java.util.List) r3
            int r8 = com.google.android.recaptcha.internal.zzje.zza
            int r3 = r3.size()
            if (r3 <= 0) goto L_0x0576
            int r8 = r10 << 3
            int r9 = com.google.android.recaptcha.internal.zzft.zzy(r3)
        ...
        L_0x0338:
            ...
            java.util.List r3 = (java.util.List) r3
            r8 = 0
            int r3 = com.google.android.recaptcha.internal.zzje.zzr(r10, r3, r8)
            goto L_0x04c8
        L_0x0345:
            r3 = 0
            java.lang.Object r8 = r2.getObject(r1, r14)
            java.util.List r8 = (java.util.List) r8
            int r3 = com.google.android.recaptcha.internal.zzje.zzp(r10, r8, r3)
            goto L_0x04c8
        L_0x0352:
            r3 = 0
            java.lang.Object r8 = r2.getObject(r1, r14)
            java.util.List r8 = (java.util.List) r8
            int r3 = com.google.android.recaptcha.internal.zzje.zzg(r10, r8, r3)
            goto L_0x04c8
        L_0x035f:
            r3 = 0
            java.lang.Object r8 = r2.getObject(r1, r14)
            java.util.List r8 = (java.util.List) r8
            int r3 = com.google.android.recaptcha.internal.zzje.zze(r10, r8, r3)
            goto L_0x04c8
        L_0x036c:
            r3 = 0
            java.lang.Object r8 = r2.getObject(r1, r14)
            java.util.List r8 = (java.util.List) r8
            int r3 = com.google.android.recaptcha.internal.zzje.zzc(r10, r8, r3)
            goto L_0x04c8
        L_0x0379:
            r3 = 0
            java.lang.Object r8 = r2.getObject(r1, r14)
            java.util.List r8 = (java.util.List) r8
            int r3 = com.google.android.recaptcha.internal.zzje.zzu(r10, r8, r3)
            goto L_0x04c8
        L_0x0386:
            java.lang.Object r3 = r2.getObject(r1, r14)
            java.util.List r3 = (java.util.List) r3
            int r3 = com.google.android.recaptcha.internal.zzje.zzb(r10, r3)
            goto L_0x04c8
        L_0x0392:
            java.lang.Object r3 = r2.getObject(r1, r14)
            java.util.List r3 = (java.util.List) r3
            com.google.android.recaptcha.internal.zzjc r8 = r0.zzC(r5)
            int r3 = com.google.android.recaptcha.internal.zzje.zzo(r10, r3, r8)
            goto L_0x04c8
        L_0x03a2:
            java.lang.Object r3 = r2.getObject(r1, r14)
            java.util.List r3 = (java.util.List) r3
            int r3 = com.google.android.recaptcha.internal.zzje.zzt(r10, r3)
            goto L_0x04c8
        L_0x03ae:
            java.lang.Object r3 = r2.getObject(r1, r14)
            java.util.List r3 = (java.util.List) r3
            r8 = 0
            int r3 = com.google.android.recaptcha.internal.zzje.zza(r10, r3, r8)
            goto L_0x04c8
        L_0x03bb:
            r3 = 0
            java.lang.Object r8 = r2.getObject(r1, r14)
        ...
        L_0x03d5:
            ...
            java.lang.Object r8 = r2.getObject(r1, r14)
            java.util.List r8 = (java.util.List) r8
            int r3 = com.google.android.recaptcha.internal.zzje.zzj(r10, r8, r3)
            goto L_0x04c8
        L_0x03e2:
            r3 = 0
            java.lang.Object r8 = r2.getObject(r1, r14)
            java.util.List r8 = (java.util.List) r8
            int r3 = com.google.android.recaptcha.internal.zzje.zzw(r10, r8, r3)
            goto L_0x04c8
        L_0x03ef:
            r3 = 0
            java.lang.Object r8 = r2.getObject(r1, r14)
            java.util.List r8 = (java.util.List) r8
            int r3 = com.google.android.recaptcha.internal.zzje.zzl(r10, r8, r3)
            goto L_0x04c8
        L_0x03fc:
            r3 = 0
            java.lang.Object r8 = r2.getObject(r1, r14)
        ...
        L_0x057d:
            ...
            java.lang.Object r4 = r3.zzd(r1)
            int r3 = r3.zza(r4)
            int r6 = r6 + r3
            boolean r3 = r0.zzh
            if (r3 == 0) goto L_0x05db
            com.google.android.recaptcha.internal.zzgr r3 = r0.zzo
            com.google.android.recaptcha.internal.zzgv r1 = r3.zzb(r1)
            r3 = r2
        L_0x0594:
            com.google.android.recaptcha.internal.zzjp r4 = r1.zza
            int r4 = r4.zzb()
            if (r2 >= r4) goto L_0x05b4
            com.google.android.recaptcha.internal.zzjp r4 = r1.zza
            java.util.Map$Entry r4 = r4.zzg(r2)
            java.lang.Object r5 = r4.getKey()
            com.google.android.recaptcha.internal.zzgu r5 = (com.google.android.recaptcha.internal.zzgu) r5
            java.lang.Object r4 = r4.getValue()
            int r4 = com.google.android.recaptcha.internal.zzgv.zza(r5, r4)
            int r3 = r3 + r4
            int r2 = r2 + 1
            goto L_0x0594
        L_0x05b4:
    ...
    private static int zzq(Object obj, long j10) {
        return ((Integer) zzkg.zzf(obj, j10)).intValue();
    }

    private final int zzr(Object obj, byte[] bArr, int i8, int i10, int i11, long j10, zzev zzev) {
        Unsafe unsafe = zzb;
        Object zzE = zzE(i11);
    ...
    private final int zzs(Object obj, byte[] bArr, int i8, int i10, int i11, int i12, int i13, int i14, int i15, long j10, int i16, zzev zzev) {
        Object obj2 = obj;
        byte[] bArr2 = bArr;
        int i17 = i8;
        int i18 = i11;
        ...
        switch (i15) {
            case 51:
                if (i20 == 1) {
                    unsafe.putObject(obj2, j11, Double.valueOf(Double.longBitsToDouble(zzew.zzq(bArr, i8))));
                    int i22 = i17 + 8;
            ...
            case 52:
                if (i20 == 5) {
                    unsafe.putObject(obj2, j11, Float.valueOf(Float.intBitsToFloat(zzew.zzb(bArr, i8))));
                    int i23 = i17 + 4;
                    unsafe.putInt(obj2, j12, i19);
                    return i23;
                }
            ...
            case 54:
                if (i20 == 0) {
                    int zzm2 = zzew.zzm(bArr2, i17, zzev2);
                    unsafe.putObject(obj2, j11, Long.valueOf(zzev2.zzb));
                    unsafe.putInt(obj2, j12, i19);
                    return zzm2;
                }
                break;
            ...
            case 62:
                if (i20 == 0) {
                    int zzj2 = zzew.zzj(bArr2, i17, zzev2);
                    unsafe.putObject(obj2, j11, Integer.valueOf(zzev2.zza));
                    unsafe.putInt(obj2, j12, i19);
                    return zzj2;
                }
                break;
            ...
            case 65:
                if (i20 == 1) {
                    unsafe.putObject(obj2, j11, Long.valueOf(zzew.zzq(bArr, i8)));
                    int i24 = i17 + 8;
                    unsafe.putInt(obj2, j12, i19);
                    return i24;
                }
            ...
            case 64:
                if (i20 == 5) {
                    unsafe.putObject(obj2, j11, Integer.valueOf(zzew.zzb(bArr, i8)));
                    int i25 = i17 + 4;
                    unsafe.putInt(obj2, j12, i19);
                    return i25;
                }
            ...
            case 58:
                if (i20 == 0) {
                    int zzm3 = zzew.zzm(bArr2, i17, zzev2);
                    unsafe.putObject(obj2, j11, Boolean.valueOf(zzev2.zzb != 0));
                    unsafe.putInt(obj2, j12, i19);
                    return zzm3;
                }
                break;
            case 59:
                if (i20 == 2) {
                    int zzj3 = zzew.zzj(bArr2, i17, zzev2);
                    int i26 = zzev2.zza;
                    if (i26 == 0) {
                        unsafe.putObject(obj2, j11, "");
                    } else if ((i14 & 536870912) == 0 || zzkl.zzf(bArr2, zzj3, zzj3 + i26)) {
                        unsafe.putObject(obj2, j11, new String(bArr2, zzj3, i26, zzhn.zzb));
                        zzj3 += i26;
                    } else {
                        throw zzhp.zzd();
                    }
            ...
            case 60:
                if (i20 == 2) {
                    Object zzG = zzG(obj2, i19, i21);
                    int zzo2 = zzew.zzo(zzG, zzC(i21), bArr, i8, i10, zzev);
                    zzP(obj2, i19, i21, zzG);
                    return zzo2;
                }
                break;
            case 61:
                if (i20 == 2) {
                    int zza2 = zzew.zza(bArr2, i17, zzev2);
                    unsafe.putObject(obj2, j11, zzev2.zzc);
                    unsafe.putInt(obj2, j12, i19);
                    return zza2;
                }
                break;
            case 63:
                if (i20 == 0) {
                    int zzj4 = zzew.zzj(bArr2, i17, zzev2);
                    int i27 = zzev2.zza;
                    zzhj zzB = zzB(i21);
                    if (zzB == null || zzB.zza(i27)) {
                        unsafe.putObject(obj2, j11, Integer.valueOf(i27));
                        unsafe.putInt(obj2, j12, i19);
                    } else {
                        zzd(obj).zzj(i18, Long.valueOf((long) i27));
                    }
                    return zzj4;
                }
                break;
            case 66:
                if (i20 == 0) {
                    int zzj5 = zzew.zzj(bArr2, i17, zzev2);
                    unsafe.putObject(obj2, j11, Integer.valueOf(zzfo.zzF(zzev2.zza)));
                    unsafe.putInt(obj2, j12, i19);
                    return zzj5;
                }
                break;
            case 67:
                if (i20 == 0) {
                    int zzm4 = zzew.zzm(bArr2, i17, zzev2);
                    unsafe.putObject(obj2, j11, Long.valueOf(zzfo.zzG(zzev2.zzb)));
                    unsafe.putInt(obj2, j12, i19);
                    return zzm4;
                }
                break;
            case 68:
                if (i20 == 3) {
                    Object zzG2 = zzG(obj2, i19, i21);
                    int zzn2 = zzew.zzn(zzG2, zzC(i21), bArr, i8, i10, (i18 & -8) | 4, zzev);
                    zzP(obj2, i19, i21, zzG2);
                    return zzn2;
                }
                break;
        }
    ...
    private final int zzt(java.lang.Object r16, byte[] r17, int r18, int r19, int r20, int r21, int r22, int r23, long r24, int r26, long r27, com.google.android.recaptcha.internal.zzev r29) {
        /*
            r15 = this;
            r0 = r15
            r1 = r16
    ...
    private final int zzv(int i8, int i10) {
        if (i8 < this.zze || i8 > this.zzf) {
            return -1;
        }
        return zzx(i8, i10);
    ...
    private final int zzx(int i8, int i10) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:113:0x032a, code lost:
        r5 = r5 + r6;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:140:0x0448, code lost:
        r4 = r4 + r5;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:190:0x056c, code lost:
        r4 = r4 + 4;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:194:0x057c, code lost:
        r4 = r4 + 8;
     */
    ...
    public final int zza(java.lang.Object r12) {
        ...
        L_0x0038:
            ...
            switch(r5) {
                ...
                case 5: goto L_0x0512;
                case 6: goto L_0x0505;
                case 7: goto L_0x04f6;
    ...
    public final int zzb(java.lang.Object r10) {
        ...
        L_0x021a:
            ...
            int r0 = r0 * 53
            com.google.android.recaptcha.internal.zzgr r1 = r9.zzo
            com.google.android.recaptcha.internal.zzgv r10 = r1.zzb(r10)
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final int zzc(java.lang.Object r34, byte[] r35, int r36, int r37, int r38, com.google.android.recaptcha.internal.zzev r39) {
        /*
            r33 = this;
            r15 = r33
            r14 = r34
    ...
    public final void zzf(Object obj) {
        if (zzW(obj)) {
            ...
            for (int i8 = 0; i8 < length; i8 += 3) {
                ...
                if (zzy != 9) {
                    if (zzy == 60 || zzy == 68) {
                        if (zzX(obj, this.zzc[i8], i8)) {
                            zzC(i8).zzf(zzb.getObject(obj, j10));
                        }
                    } else {
                        switch (zzy) {
                            case 17:
            ...
            switch (zzy(zzz)) {
                case 0:
                    if (!zzT(obj2, i8)) {
                        ...
                        zzkg.zzo(obj, j10, zzkg.zza(obj2, j10));
                        zzM(obj, i8);
                        break;
                    }
                case 1:
                    if (!zzT(obj2, i8)) {
                        ...
                        zzkg.zzp(obj, j10, zzkg.zzb(obj2, j10));
                        zzM(obj, i8);
                        break;
                    }
                case 2:
                    if (!zzT(obj2, i8)) {
                        ...
                        zzkg.zzr(obj, j10, zzkg.zzd(obj2, j10));
                        zzM(obj, i8);
                        break;
                    }
                case 3:
                ...
                case 4:
                    if (!zzT(obj2, i8)) {
                        ...
                        zzkg.zzq(obj, j10, zzkg.zzc(obj2, j10));
                        zzM(obj, i8);
                        break;
                    }
                case 5:
                ...
                case 7:
                    if (!zzT(obj2, i8)) {
                        ...
                        zzkg.zzm(obj, j10, zzkg.zzw(obj2, j10));
                        zzM(obj, i8);
                        break;
                    }
                case 8:
                    if (!zzT(obj2, i8)) {
                        ...
                        zzkg.zzs(obj, j10, zzkg.zzf(obj2, j10));
                        zzM(obj, i8);
                        break;
                    }
                case 9:
                ...
                case 50:
                    int i11 = zzje.zza;
                    zzkg.zzs(obj, j10, zzik.zzc(zzkg.zzf(obj, j10), zzkg.zzf(obj2, j10)));
                    break;
                case 51:
                case 52:
                case 53:
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void zzh(java.lang.Object r18, com.google.android.recaptcha.internal.zzjb r19, com.google.android.recaptcha.internal.zzgq r20) {
        /*
            r17 = this;
            r7 = r17
            r15 = r18
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void zzi(java.lang.Object r31, byte[] r32, int r33, int r34, com.google.android.recaptcha.internal.zzev r35) {
        /*
            r30 = this;
            r15 = r30
            r14 = r31
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void zzj(java.lang.Object r18, com.google.android.recaptcha.internal.zzko r19) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
    ...
    public final boolean zzk(Object obj, Object obj2) {
        ...
        for (int i8 = 0; i8 < length; i8 += 3) {
            ...
            switch (zzy(zzz)) {
                case 0:
                    if (zzR(obj, obj2, i8) && Double.doubleToLongBits(zzkg.zza(obj, j10)) == Double.doubleToLongBits(zzkg.zza(obj2, j10))) {
                        continue;
                    }
                case 1:
                    if (zzR(obj, obj2, i8) && Float.floatToIntBits(zzkg.zzb(obj, j10)) == Float.floatToIntBits(zzkg.zzb(obj2, j10))) {
                        continue;
                    }
                case 2:
                    if (zzR(obj, obj2, i8) && zzkg.zzd(obj, j10) == zzkg.zzd(obj2, j10)) {
                        continue;
                    }
                case 3:
                    if (zzR(obj, obj2, i8) && zzkg.zzd(obj, j10) == zzkg.zzd(obj2, j10)) {
                ...
                case 4:
                    if (zzR(obj, obj2, i8) && zzkg.zzc(obj, j10) == zzkg.zzc(obj2, j10)) {
                        continue;
                    }
                case 5:
                    if (zzR(obj, obj2, i8) && zzkg.zzd(obj, j10) == zzkg.zzd(obj2, j10)) {
                ...
                case 7:
                    if (zzR(obj, obj2, i8) && zzkg.zzw(obj, j10) == zzkg.zzw(obj2, j10)) {
                        continue;
                    }
                case 8:
                    if (zzR(obj, obj2, i8) && zzje.zzX(zzkg.zzf(obj, j10), zzkg.zzf(obj2, j10))) {
                        continue;
                    }
                case 9:
                    if (zzR(obj, obj2, i8) && zzje.zzX(zzkg.zzf(obj, j10), zzkg.zzf(obj2, j10))) {
                ...
                case 48:
                case 49:
                    z10 = zzje.zzX(zzkg.zzf(obj, j10), zzkg.zzf(obj2, j10));
                    break;
                case 50:
                    z10 = zzje.zzX(zzkg.zzf(obj, j10), zzkg.zzf(obj2, j10));
                    break;
                ...
                case 67:
                case 68:
                    long zzw = (long) (zzw(i8) & 1048575);
                    if (zzkg.zzc(obj, zzw) == zzkg.zzc(obj2, zzw) && zzje.zzX(zzkg.zzf(obj, j10), zzkg.zzf(obj2, j10))) {
                        continue;
                    }
            }
            if (!z10) {
    ...
    public final boolean zzl(Object obj) {
        ...
        while (i12 < this.zzk) {
            ...
            if ((268435456 & zzz) != 0 && !zzU(obj, i14, i10, i8, i18)) {
                return false;
            }
            int zzy = zzy(zzz);
            if (zzy != 9 && zzy != 17) {
                if (zzy != 27) {
                    if (zzy == 60 || zzy == 68) {
                        if (zzX(obj2, i15, i14) && !zzV(obj2, zzz, zzC(i14))) {
                            return false;
                        }
                    } else if (zzy != 49) {
                        if (zzy == 50 && !((zzij) zzkg.zzf(obj2, (long) (zzz & 1048575))).isEmpty()) {
                            zzii zzii = (zzii) zzE(i14);
                            throw null;
                        }
                    }
                }
            ...
            } else if (zzU(obj, i14, i10, i8, i18) && !zzV(obj2, zzz, zzC(i14))) {
                return false;
            }
            i12++;
            i13 = i10;

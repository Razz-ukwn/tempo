...
public final class i {
    ...
    public i(Context context, String str) {
        this.f12259a = context.getSharedPreferences("FirebaseHeartBeat" + str, 0);
    }

    public final synchronized void a() {
        long j10 = this.f12259a.getLong("fire-count", 0);
        String str = "";
        String str2 = null;
        for (Map.Entry next : this.f12259a.getAll().entrySet()) {
        ...
        HashSet hashSet = new HashSet(this.f12259a.getStringSet(str, new HashSet()));
        hashSet.remove(str2);
        this.f12259a.edit().putStringSet(str, hashSet).putLong("fire-count", j10 - 1).commit();
    }
    ...
    public final synchronized java.util.ArrayList c() {
        /*
            ...
            android.content.SharedPreferences r1 = r5.f12259a     // Catch:{ all -> 0x005c }
        ...
        L_0x0014:
            ...
            oa.a r2 = new oa.a     // Catch:{ all -> 0x005c }
        ...
        L_0x0042:
            ...
            android.content.SharedPreferences r3 = r5.f12259a     // Catch:{ all -> 0x0059 }
        ...
        L_0x005c:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: oa.i.c():java.util.ArrayList");
    }
    ...
    public final synchronized void f(java.lang.String r5) {
        ...
        L_0x0009:
            ...
            android.content.SharedPreferences r2 = r4.f12259a     // Catch:{ all -> 0x003f }
            ...
            android.content.SharedPreferences r5 = r4.f12259a     // Catch:{ all -> 0x003f }
        ...
        L_0x003f:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: oa.i.f(java.lang.String):void");
    }
    ...
    public final synchronized boolean g(long r6) {
        /*
            ...
            monitor-enter(r5)
            android.content.SharedPreferences r1 = r5.f12259a     // Catch:{ all -> 0x0048 }
        ...
        L_0x0048:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: oa.i.g(long):boolean");
    }

    public final synchronized void h(String str, long j10) {
        String d10 = d(j10);
        if (this.f12259a.getString("last-used-date", "").equals(d10)) {
            String e10 = e(d10);
            if (e10 != null) {
                if (!e10.equals(str)) {
                    i(str, d10);
        ...
        long j11 = this.f12259a.getLong("fire-count", 0);
        if (j11 + 1 == 30) {
            a();
            j11 = this.f12259a.getLong("fire-count", 0);
        }
        HashSet hashSet = new HashSet(this.f12259a.getStringSet(str, new HashSet()));
        hashSet.add(d10);
        this.f12259a.edit().putStringSet(str, hashSet).putLong("fire-count", j11 + 1).putString("last-used-date", d10).commit();
    }
    ...
    public final synchronized void i(String str, String str2) {
        ...
        HashSet hashSet = new HashSet(this.f12259a.getStringSet(str, new HashSet()));
        hashSet.add(str2);
        this.f12259a.edit().putStringSet(str, hashSet).commit();
    }
}

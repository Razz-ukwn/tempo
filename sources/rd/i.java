...
public final class i extends k implements l<g<LoginWithPhoneResponseModel>, m> {

    /* renamed from: a  reason: collision with root package name */
    public final /* synthetic */ ProfileFragment f14226a;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public i(ProfileFragment profileFragment) {
        super(1);
        this.f14226a = profileFragment;
    }
    ...
    public final Object invoke(Object obj) {
        ...
        ProfileFragment profileFragment = this.f14226a;
        if (z10) {
            ...
            if (bVar != null) {
                ...
                if (str != null) {
                    ...
                    d.d(profileFragment, string, str, "OK", (String) null, false, f.f14217a, g.f14218a);
                }
            } else {
                j.l("loadingAlert");
                throw null;
            ...
            if (gVar instanceof g.c) {
                ...
                if (bVar3 != null) {
                    ...
                    if (!(loginWithPhoneResponseModel == null || (data = loginWithPhoneResponseModel.getData()) == null)) {
                        cb.b.D(cb.d.I(profileFragment), (f.b) null, 0, new h(profileFragment, data, gVar, (jf.d<? super h>) null), 3);
                    }
                } else {
                    j.l("loadingAlert");
                    throw null;

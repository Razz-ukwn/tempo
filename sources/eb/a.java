...
public final class a {
    ...
    public static final TimeZone f7909a = TimeZone.getTimeZone("UTC");

    public static boolean a(String str, int i8, char c3) {
        return i8 < str.length() && str.charAt(i8) == c3;
    }
    ...
    public static java.util.Date b(java.lang.String r17, java.text.ParsePosition r18) {
        ...
        L_0x0215:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: eb.a.b(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    public static int c(int i8, int i10, String str) {
        int i11;
        int i12;
        if (i8 < 0 || i10 > str.length() || i8 > i10) {
        ...
        if (i8 < i10) {
            ...
            if (digit >= 0) {
                ...
                throw new NumberFormatException("Invalid number: " + str.substring(i8, i10));
            }
        } else {
            i11 = 0;
            i12 = i8;

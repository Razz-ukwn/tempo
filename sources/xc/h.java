...
public final class h extends k implements l<g<LoginWithPhoneResponseModel>, m> {
    ...
    public final /* synthetic */ LoginBottomSheet f17045a;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public h(LoginBottomSheet loginBottomSheet) {
        super(1);
        this.f17045a = loginBottomSheet;
    }
    ...
    public final Object invoke(Object obj) {
        ...
        LoginBottomSheet loginBottomSheet = this.f17045a;
        if (z10) {
            ...
            if (bVar != null) {
                ...
                if (str != null) {
                    ...
                    d.d(loginBottomSheet, string, str, "OK", (String) null, false, e.f17039a, f.f17040a);
                }
            } else {
                j.l("loadingAlert");
                throw null;
            ...
            if (gVar instanceof g.c) {
                ...
                if (bVar3 != null) {
                    ...
                    if (!(loginWithPhoneResponseModel == null || (data = loginWithPhoneResponseModel.getData()) == null)) {
                        cb.b.D(cb.d.I(loginBottomSheet), (f.b) null, 0, new g(loginBottomSheet, data, (jf.d<? super g>) null), 3);
                    }
                } else {
                    j.l("loadingAlert");
                    throw null;

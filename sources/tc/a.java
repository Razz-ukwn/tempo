...
public final /* synthetic */ class a implements InputFilter {
    ...
    public final /* synthetic */ CreateAccountBottomSheet f15569a;

    public /* synthetic */ a(CreateAccountBottomSheet createAccountBottomSheet) {
        this.f15569a = createAccountBottomSheet;
    }
    ...
    public final CharSequence filter(CharSequence charSequence, int i8, int i10, Spanned spanned, int i11, int i12) {
        ...
        CreateAccountBottomSheet createAccountBottomSheet = this.f15569a;

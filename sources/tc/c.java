...
public final /* synthetic */ class c implements InputFilter {
    ...
    public final /* synthetic */ CreateAccountBottomSheet f15571a;

    public /* synthetic */ c(CreateAccountBottomSheet createAccountBottomSheet) {
        this.f15571a = createAccountBottomSheet;
    }
    ...
    public final CharSequence filter(CharSequence charSequence, int i8, int i10, Spanned spanned, int i11, int i12) {
        ...
        CreateAccountBottomSheet createAccountBottomSheet = this.f15571a;
